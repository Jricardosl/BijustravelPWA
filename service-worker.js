  ...
  event.waitUntil(
    caches.open(cacheName)
      .then(cache => cache.addAll([
        ...
        './assets/imagens/128.png',

        './assets/imagens/144.png',

        './assets/imagens/152.png',

        './assets/imagens/167.png',

        //'./assets/images/172.png',

        './assets/imagens/180.png',

        './assets/imagens/196.png',

        //'./assets/images/216.png',

        './assets/imagens/256.png',

        './assets/imagens/512.png',
